//function insert images on their boxes
...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        // To delete the eliminate other team element
        ...
        // Function to show the available paths for  pieces
...
// avoiding  from selecting multiple elements
z = 0
